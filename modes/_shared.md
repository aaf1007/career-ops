...
| Read | cv.md, _profile.md, article-digest.md, cv-template.html, cv-template.tex |
| Write | Temporary HTML/LaTeX for PDF, applications.md, reports .md |
| Edit | Update tracker |
...
| Bash | `node generate-pdf.mjs` (HTML→PDF, experienced candidates) · `node generate-latex.mjs` (LaTeX→PDF, students/new grads) |
